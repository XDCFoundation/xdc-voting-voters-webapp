                                            ...
                                            props.state.proposalDocuments.map((doc, index) => {
                                                return (
                                                    <div className="display-flex m-t-4">
                                                        <div
                                                            className={classes.input + " display-flex justify-content-between"}
                                                            value={uploadDocument}
                                                        >
                                                            <div style={{textAlign: "left"}}
                                                                 className="p-l-sm p-t-sm">{doc}</div>
                                                            <BrowseButton  for={"fileButton"+index}>
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={(e) => props.uploadFileToS3(e.target.files[0], index)}
                                                                />
                                                            </BrowseButton>
                                                        </div>
                                                        {index === props.state.proposalDocuments.length - 1 ?
                                                            <img className={classes.imag}
                                                                 onClick={props.addDocumentRow} src="/images/Add.svg"/>
                                                            :
                                                            <img className={" height-27 m-t-4 width-27 m-l-4"}
